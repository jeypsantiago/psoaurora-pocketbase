<script>
    ...
    async function submit() {
        ...
        try {
            await ApiClient.collection("_superusers").create(
                ...
                {
                    headers: { Authorization: setupToken },
                },
            );
            ...
            if (!(await handleSetupSessionError(err))) {
                ApiClient.error(err);
            }
        }
    ...
    async function handleSetupSessionError(err) {
